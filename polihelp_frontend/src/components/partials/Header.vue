    ...
    <header class="site-navbar site-navbar-target" role="banner">
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="col-3">
            <div class="site-logo">
              <a class="font-weight-bold"><router-link to="/">Home</router-link></a>
            </div>
          </div>
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul v-if="!$store.state.auth.user" class="site-menu main-menu js-clone-nav ml-auto">
                <li><a class="nav-link"><router-link to="/login">Conectare</router-link></a></li>
                <li><a class="nav-link"><router-link to="/register">Inregistrare</router-link></a></li>
              </ul>
              <ul v-else class="site-menu main-menu js-clone-nav ml-auto">
                ...
                <li><a class="nav-link"><router-link :to="{ path: '/notifications' }">Notificari</router-link></a></li>
